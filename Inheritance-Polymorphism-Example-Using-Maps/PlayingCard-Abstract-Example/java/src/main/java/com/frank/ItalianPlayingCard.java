...
public class ItalianPlayingCard extends PlayingCard {
	...
	public ItalianPlayingCard(int value, String suit) {
		super(value, suit, suitMap.get(suit));   // we are using suitMap assuming it has already been initialized
		// WE don't actually initialize the Maps until the end of this ctor
		// IF a default ctor was not run before this ctor, the Maps are not initiazied

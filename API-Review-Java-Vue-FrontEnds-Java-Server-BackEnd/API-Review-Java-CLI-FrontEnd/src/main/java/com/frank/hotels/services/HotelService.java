...
public class HotelService {
   ...
   * @param reservationString
   * @return
   */
  public Reservation updateReservation(String reservationString) {
    Reservation reservation = makeReservation(reservationString);
    if (reservation == null) {
      return null;
    }
  ...
  private Reservation makeReservation(String reservationString) {
    String[] parsed = reservationString.split(",");

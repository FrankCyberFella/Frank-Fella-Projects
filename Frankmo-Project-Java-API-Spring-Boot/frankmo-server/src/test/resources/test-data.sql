...
DROP TABLE IF EXISTS transfer, account, frankmo_user, transfer_type, transfer_status;
...
CREATE TABLE frankmo_user (
	user_id int NOT NULL DEFAULT nextval('seq_user_id'),
	username varchar(50) UNIQUE NOT NULL,
	password_hash varchar(200) NOT NULL,
	role varchar(20),
	CONSTRAINT PK_frankmo_user PRIMARY KEY (user_id),
...
CREATE TABLE account (
	...
	CONSTRAINT FK_account_frankmo_user FOREIGN KEY (user_id) REFERENCES frankmo_user (user_id)
);
...
INSERT INTO frankmo_user (username,password_hash,role) VALUES ('user1','user1','ROLE_USER'); -- 1001
INSERT INTO frankmo_user (username,password_hash,role) VALUES ('user2','user2','ROLE_USER'); -- 1002
INSERT INTO frankmo_user (username,password_hash,role) VALUES ('user3','user3','ROLE_USER');
